using Telegram.Bot; using Telegram.Bot.Types.Enums; using Telegram.Bot.Types; using Telegram.Bot.Types.InputFiles;

namespace TelegramWordBot;

public class TelegramMessageHelper { private readonly ITelegramBotClient _bot;
